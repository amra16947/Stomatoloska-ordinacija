...
?>
			   ...
			   {  ?>
				       ...
				       <form class ="lista_novosti" id = "novosti" action="prikazi_novosti.php" method="post">
					      ...
					      <br>
							 <label> Naslov: </label>
                            <input id="naslov_clanak" name="naslov_clanak" Value="<?php echo $lista_novosti[$i]->naslov ?>" readonly></input>
							...
							<tr>
					        <label> Tekst: </label>
                            <input id="tekst_clanak" name="tekst_clanak" Value="<?php echo $lista_novosti[$i]->tekst ?>" readonly></input>
					        <br>
					        </tr>
                      ...
                      <td> <br> <a href = "uredi_novost.php?id_novosti=<?php echo $lista_novosti[$i]->id ?>" id = "dugme_novosti_uredi" name = "dugme_uredi"> Uredi novost </td>
